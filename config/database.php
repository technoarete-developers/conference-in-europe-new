    ...
    */
    ...
    'connections' => [
        ...
        'test_my_sql' => [
            ...
            'host' => env('DB_HOST_TEST', 'master-test.c1whrlnb6dpc.ap-south-1.rds.amazonaws.com'),
        ...
        'production_my_sql' => [
            'driver' => 'mysql',
            'url' => env('DATABASE_URL_SERVER'),
            'host' => env('DB_HOST_PRODUCTION', 'master-test.c1whrlnb6dpc.ap-south-1.rds.amazonaws.com'),
