                                    ...
                                    <div class="modal-content moddd">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <form method="post" id="subscribe-form"
                                                action="{{ route('event-subscribe-form-fr') }}"
                                                ...
                                                <input type="text" name="email" id="email"
                                                    placeholder="Adresse email" class="form-control">
                                                ...
                                                <input type="text" name="mobile_number" id="mobile_number"
                                                    placeholder="Numéro de contact" class="form-control">

                                                <select id="category" name="category" class="field form-control"
                                                    required="">
                                                    <option value="">--Sélectionnez une catégorie--</option>
                                                    <option value="Listener">Auditrice</option>
                                                    <option value="Paper Presentation">Présentation papier</option>
