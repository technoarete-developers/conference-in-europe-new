...
@section('meta')
    <title>{{ str_replace(['@city', '@topic'], [$cityNameFr, $topicNameFr], $content['title']) }}</title>
    <meta name="keyword" content="{{ str_replace(['@city', '@topic'], [$cityNameFr, $topicNameFr], $content['metaKey']) }}" />
    <meta name="description"
        content="{{ str_replace(['@city', '@topic'], [$cityNameFr, $topicNameFr], $content['metaDes']) }}" />

    <meta property="og:title"
        content="{{ str_replace(['@city', '@topic'], [$cityNameFr, $topicNameFr], $content['title']) }}" />
    <meta property="og:keywords"
        content="{{ str_replace(['@city', '@topic'], [$cityNameFr, $topicNameFr], $content['metaKey']) }}" />
                                        ...
                                        <div class="county-conference">
                                            <div class="col-md-12">
                                                <h1 style=" font-size: 18px;font-family:Gill Sans;">
                                                    {{ str_replace(['@city', '@topic'], [$cityNameFr, $topicNameFr], $content['h1']) }}
                                                </h1>
                                                <p>{{ str_replace(['@city', '@topic'], [$cityNameFr, $topicNameFr], $content['contentOne']) }}
                                                </p>
                                                <p>{{ str_replace(['@city', '@topic'], [$cityNameFr, $topicNameFr], $content['contentTwo']) }}
                                                </p>
                                            </div>
                                        </div>
                                    </div>
