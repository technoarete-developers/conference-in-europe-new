...
@section('meta')
    <title>Subscribe to Conference in Europe</title>
    <meta name="keyword" content="" />
    <meta name="description" content="Subscribe to Conference in Europe portal and get lnformation in your inbox." />

    <meta property="og:title" content="Subscribe to Conference in Europe" />
            ...
            <div class="container">
                ...
                <div class="mainrow">
                    <div class="col-md-12">
                        <div class="row">
                            <div class="col-md-6">
                                <form method="POST" id="subform_1" class="example" action="{{ route('subscribe-form') }}" class="well form-horizontal">
                                    @csrf
                                    <fieldset>
                                        ...
                                        <div class="form-group">
                                            <div class="inputGroupContainer d-flex">
                                                <div class="input-group col-md-6">
                                                    <span class="input-group-addon"><i class="fa fa-phone"
                                                            aria-hidden="true"></i></span>
                                                    <select id="slct1" name="country_code"
                                            ...
                                            <div class="col-md-12 inputGroupContainer">
                                                <div class="input-group">
                                                    <span class="input-group-addon"><i class="fa fa-map-marker"
                                                            aria-hidden="true"></i></span>
                                                    <select id="slct1" name="topic"
                                                        class="field form-control text-capitalize" required="">
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-12 inputGroupContainer">
                                                <div class="input-group">
                                                    <span class="input-group-addon"><i class="fa fa-envelope"
                                                            aria-hidden="true"></i></span>
                                                    <input name="university_org"
                                                        placeholder="Enter university/organisation" required
                                                        class="form-control" type="text">
                                                </div>
                                            </div>
                                        </div>
    ...
    @section('script')
        ...
        <script>
            function onClick(e) {
                ...
                const form = document.getElementById("subform_1");
                ...
                grecaptcha.ready(function() {
                    grecaptcha.execute('{{ config('services.recaptcha.site_key') }}', {
                        ...
                        document.getElementById('subform_1').submit();
                    });
                });
            }
        </script>
