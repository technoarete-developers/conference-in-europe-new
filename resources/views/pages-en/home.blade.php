                                ...
                                <div class="tabContent">
                                    <div class="tabItem active">
                                        @foreach ($topCountry as $url => $name)
                                            <a href="{{ route('country-page', ['country' => $url]) }}"
                                    ...
                                    <div class="tabItem">
                                        @foreach ($topCity as $url => $name)
                                            <a href="{{ route('city-page', ['city' => $url]) }}"
