...
@section('meta')
    <title>
        {{ str_replace(['@country', '@topic', '@month'], [$countryName, $topicName, $monthName], $content['title']) }}
    </title>
    <meta name="keyword"
        content="{{ str_replace(['@country', '@topic', '@month'], [$countryName, $topicName, $monthName], $content['metaKey']) }}" />
    <meta name="description"
        content="{{ str_replace(['@country', '@topic', '@month'], [$countryName, $topicName, $monthName], $content['metaDes']) }}" />

    <meta property="og:title"
        content="{{ str_replace(['@country', '@topic', '@month'], [$countryName, $topicName, $monthName], $content['title']) }}" />
                                        ...
                                        <div class="county-conference">
                                            <div class="col-md-12">
                                                <h1 style=" font-size: 18px;font-family:Gill Sans;">
                                                    {{ str_replace(['@country', '@topic', '@month'], [$countryName, $topicName, $monthName], $content['h1']) }}
                                                </h1>
                                                <p>{{ str_replace(['@country', '@topic', '@month'], [$countryName, $topicName, $monthName], $content['contentOne']) }}
                                                </p>
                                                <p>{{ str_replace(['@country', '@topic', '@month'], [$countryName, $topicName, $monthName], $content['contentTwo']) }}
                                                </p>
                                            </div>
                                        </div>
                                    </div>
